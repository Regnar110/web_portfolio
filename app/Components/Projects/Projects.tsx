...
const Projects = () => {
    return (
        <section className='projects_section flex flex-col items-center justify-center w-full md:w-[80%] mb-28  gap-x-4 p-8 gap-y-10 border-l-[1px] border-r-[1px] border-dashed border-[#d038386c]'>
            {
                projects.map((el,i) => (
