  ...
  return isMounted ? 
    <nav className={`navigation ${isNavFixed ? "fixed":"relative"} top-0 z-50 w-full grid grid-cols-2 items-center justify-items-center gap-5 h-[80px] bg-[#111525]`}>
      <MediaQuery minWidth={768}>
        <div className='nav_lnks flex justify-center items-center font-medium text-white text-[14px] gap-10'>
          <div><Lottie  className=' w-[60px]' animationData={succes_space} loop={true}/></div>
