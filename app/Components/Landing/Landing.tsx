...
const Landing = () => {
  return (
    <section className='landing_section bg-[#111525] md:flex grid auto-rows-2 items-center md:justify-center md:flex-row max-w-[2000px] border-b-[1px] border-[#D03838]'>
        <ParallaxProvider>
            ...
            <div className='landing_headers mt-20 md:mt-0 flex flex-col items-center justify-center w-full text-white '>
                <div className='w-fit flex flex-col items-start justify-center'>
                    <Fade direction='left'><h1 className='text-[30px] sm:text-[37px] lg:text-[45px] xl:text-[50px] 2xl:text-[60px] font-extrabold w-fit'>FRONT - END SOFTWARE</h1></Fade>
                    <Fade direction='right' delay={500}><h2 className='text-[#D03838] text-[25px] sm:text-[27px] lg:text-[35px] xl:text-[40px] 2xl:text-[50px] font-extrabold w-fit'>WEB DEVELOPER</h2></Fade>
                    
                    <Zoom className=' max-w-[300px] 2xl:max-w-[420px]' delay={1000}>
                        <span className='text-[12px] text-center md:text-left sm:text-[12px] lg:text-[14px]'>
